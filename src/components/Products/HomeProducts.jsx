      ...
      {showModal && selectedProduct && (
        <div className="product-modal-overlay" onClick={() => setShowModal(false)}>
          <div className="product-modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="img">
              <img className="product-modal-image" src={selectedProduct.image_link} alt={selectedProduct.name} />
            </div>
            <div className="product-modal-price">{selectedProduct.price}</div>
            <div className="product-modal-description">{selectedProduct.review}</div>
