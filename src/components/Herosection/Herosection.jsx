...
import gardenGif from "../../assets/gardengif.gif";
  ...
  return (
    <section className="hero-section" id="home">
      ...
      <div className="hero-content">
        <h1><span>GreenBloom</span> – "The Future of Herbal Wisdom is Here"</h1>
        {/* <div className="hero-image">
          <img src={gardenGif} alt="Herbal Garden" />
        </div> */}
        <p>Step into a world where nature meets innovation 🌿 Discover the power of herbs through immersive visuals and rich plant knowledge.✨</p>
        <Link to="/explore-plants" className="hero-btn">
...
//         <p>Discover, Explore & Learn about Nature's Healing Plants</p>
//         <Link to="/explore-plants" className="hero-btn">Get Started</Link>
//       </div>
//       <div className="hero-image">
//         <img src={gardenGif} alt="Herbal Garden" />
//       </div>
