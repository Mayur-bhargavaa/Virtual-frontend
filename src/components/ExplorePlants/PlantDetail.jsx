...
//           <h2 className="modal-heading">{plant.commonName}cvhbm</h2>

//           <div className="plant-info-container">

//           <div className="allname">
//             <div className="allNamePlant">Sanskrit Name: <span> {plant.sanskritName}huhu</span></div>
//             <div className="allNamePlant">Botanical Name: <span> {plant.botanicalName}vh</span></div>
//           </div>
...
//               <button className="btn-secondary" onClick={() => setIsSecondaryContainerOpen(true)}>AYUSH Application 🌿</button>
//               <button className="btn-secondary" onClick={() => setIsSecondaryContainerOpen(true)}>Health Benefits 🌿</button>
//             </div>
//           </div>
...
//         <button className="close-btn" onClick={() => setIsSecondaryContainerOpen(false)}>X</button>
//         <h3>Plant Details</h3>
//         <p>Here you can show AYUSH uses, health benefits, etc...</p>
//         {/* You can dynamically load plant.ayushApplications or plant.healthBenefits data also */}
//       </div>
// )}
...
//   const [viewType, setViewType] = useState("image");
//   const [isSecondaryContainerOpen, setIsSecondaryContainerOpen] = useState(false);
//   const [currentSecondaryContent, setCurrentSecondaryContent] = useState("ayush");
...
//                   onClick={() => handleSecondaryContentChange("ayush")}
//                 >
//                   AYUSH Application 🌿
//                 </button>
//                 <button 
//                   className="btn-secondary" 
//                   onClick={() => handleSecondaryContentChange("health")}
//                 >
//                   Health Benefits 🌿
//                 </button>
//               </div>
...
//       {/* Secondary Container for AYUSH Application or Health Benefits */}
//       {isSecondaryContainerOpen && (
//         <div className="secondary-container">
//           <button className="close-btn" onClick={() => setIsSecondaryContainerOpen(false)}>X</button>
...
//               ? plant.ayushApplications?.join(", ") || "No AYUSH applications available."
//               : plant.healthBenefits?.join(", ") || "No health benefits available."}
//           </p>
//         </div>
//       )}
//     </>
